	...
	public function MostrarAnularReserva($telefono){
		...
		$numero=$sentencia->rowCount();
			if($numero==0){
				...
				echo "<td style='text-align:center'>Hora</td>";
				echo "<td style='text-align:center'>Mesa</td>";
			foreach ($lista_reserva as $resultado) {
				$id_reserva=$resultado["id_reserva"];
				echo "<tr>";
				echo "<td style='text-align:center'>".$resultado['id_reserva']."</td>";
				echo "<td style='text-align:center'>".$resultado['telf_reserva']."</td>";
				echo "<td style='text-align:center'>".$resultado['nombre_reserva']."</td>";
				echo "<td style='text-align:center'>".$resultado['fecha_reserva']."</td>";
				echo "<td style='text-align:center'>".$resultado['hora_reserva']."</td>";
				echo "<td style='text-align:center'>".$resultado['id_mesa']."</td>";
				echo "<td><a href='../view/anular_reserva.php?id_reserva="."$id_reserva"."'>Eliminar</a></td>";
				echo "</tr>";
			}
		}
	}
